    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task1()
        {
            IEnumerable<Emp> result = 
                Emps.Where(emp => emp.Job == "Backend programmer")
                .ToList();
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = 
                Emps.Where(emp => emp.Job=="FrontendProgrammer" && emp.Salary > 10004).OrderByDescending(emp => emp.Ename)
                    .ToList();
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = 
                Emps.Where(emp => emp.Salary == Task3())
                    .ToList();
            return result;
        }
        ...
        public static IEnumerable<object> Task5()
        {
            IEnumerable<object> result = 
                Emps.Select(emp => new { Nazwisko = emp.Ename, Praca = emp.Job }).ToList();
            return result;
        }
        ...
        {
            IEnumerable<object> result = 
                    Emps.Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emp, dept) => new
                        {
                            dept.Dname, 
                            emp.Ename
                        })
                        .GroupBy(data => data.Dname)
                        .Select(data => new
                        {
                            name = data.Key, 
                            numOfEmployees = data.Count()
                        })
                        .ToList();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result =
                Depts.GroupJoin(Emps, d => d.Deptno, e => e.Deptno, (d, e) => new
                    {
                        d.Deptno,
                        d.Dname,
                        d.Loc,
                    ...
                    .Where(gr => gr.Employees == 5 || gr.Employees == 0)
                    .Select(d => new Dept
                    {
                        Deptno = d.Deptno,
                        Dname = d.Dname,
